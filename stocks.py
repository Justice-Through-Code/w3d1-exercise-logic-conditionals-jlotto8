...
def stock_purchases():
    ...
    invest_client = int(input("How much would you like to invest? "))
    ...
    print(f'{name} has ${invest_client} to invest and can buy {num_stock} shares of {stock_name} at the current price of ${stock}.')
